...
#ifndef MJPC_TASKS_QUADROTOR2_QUADROTOR2_H_
#define MJPC_TASKS_QUADROTOR2_QUADROTOR2_H_
 ...
 public:
  ...
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    ...
    explicit ResidualFn(const Quadrotor2* task) : mjpc::BaseResidualFn(task) {}
