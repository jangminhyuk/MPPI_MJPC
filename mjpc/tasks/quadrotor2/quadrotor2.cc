...
#include "mjpc/tasks/quadrotor2/quadrotor2.h"
...
namespace mjpc {
std::string Quadrotor2::XmlPath() const {
  return GetModelPath("quadrotor2/task.xml");
}
std::string Quadrotor2::Name() const { return "Quadrotor2"; }
...
// ------------------------------------------------------------
void Quadrotor2::ResidualFn::Residual(const mjModel* model, const mjData* data,
...
void Quadrotor2::TransitionLocked(mjModel* model, mjData* data) {
